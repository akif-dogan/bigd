...
ldflags= \
-X "go.thebigfile.com/bigd/build.BinaryName=siad" \
-X "go.thebigfile.com/bigd/build.NodeVersion=1.5.9" \
-X "go.thebigfile.com/bigd/build.GitRevision=${GIT_DIRTY}${GIT_REVISION}" \
-X "go.thebigfile.com/bigd/build.BuildTime=${BUILD_TIME}"
